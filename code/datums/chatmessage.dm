...
/datum/chatmessage/proc/generate_image(text, atom/target, mob/owner, datum/language/language, list/extra_classes, lifespan)
	...
	if (extra_classes.Find("virtual-speaker"))
		...
		LAZYADD(prefixes, "\icon[r_icon]")
/* Language Datums: https://github.com/tgstation/tgstation/pull/25333
	// Append language icon if the language uses one
	var/datum/language/language_instance = global.language_datum_instances[language]
...
*/
	...
	var/complete_text = "<center><span class='maptext [extra_classes.Join(" ")]' style='color: [tgt_color]'>[text]</span></center>"
...
/mob/proc/create_chat_message(atom/movable/speaker, datum/language/message_language, raw_message, list/spans, runechat_flags = NONE)
	...
	// Virtual Speaker: https://github.com/tgstation/tgstation/pull/4337
...
// Language Datums: https://github.com/tgstation/tgstation/issues/25333
//	else
